...
```
User Input (file, folder, or scope description)
     |
     v
+---------------+
|  Step 1:      |
...
**1c. Capture baseline metrics** (run what's available):
...
**1d. Read all target files** using the Read tool. For large scopes (>15 files), prioritize:
