...
### Devil's Advocate Round (MANDATORY before closing)
...
3. **{Scope risk}:** Based on the {N} stories planned, this is a {size} effort.
   Research suggests success rates drop significantly for PRDs with >20 stories.
   → Should we phase this into multiple releases?

4. **{Missing consideration}:** Research mentioned {thing} that we haven't discussed.
